...
const forcast=(latitude,longitude,callback)=>{
    ...
    request({url,json:true},(error,{body})=>{
        ...
        if(error){
                   ...
                   if(humidity>80){
                    callback(undefined,"there is 70% cahnce of rainbecause humdity is:"+humidity)
                   }
                   else if(humidity>60&&humidity<100){
                    callback(undefined,'there is 50% chance of rain because humdity is:'+humidity)
                   }
                   else{
                    callback(undefined,"there is no 0% chance of rainbecause humdity is:"+humidity)
                   }
                }
